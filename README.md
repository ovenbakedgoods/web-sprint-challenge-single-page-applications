...
useRouteMatch lets us use history. With this we can navigate history and location
1. How would you explain form validation to someone who has never programmed before?
Form validation is just making sure the buttons can be clicked and send data and text can by typed where it should
1. In 1-2 sentences, define end to end testing.
end to end testing is a testing of the whole system.
This is beyond integration testing and unit testing.
